...
namespace EFUnivesityData.Migrations
{
    ...
    partial class UnivesityContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("EFUnivesityDomain.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InstructorId = 1,
                            Name = "Engenierr",
                            StartDate = new DateTime(2023, 3, 31, 11, 52, 41, 764, DateTimeKind.Local).AddTicks(8412)
                        });
                });
            ...
            modelBuilder.Entity("EFUnivesityDomain.Instructor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            FirstMidName = "Juan",
                            HireDate = new DateTime(2023, 3, 31, 11, 52, 41, 764, DateTimeKind.Local).AddTicks(8387),
                            LastName = "Solares"
                        });
                });
            ...
            modelBuilder.Entity("EFUnivesityDomain.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EnrollmentDate = new DateTime(2023, 3, 31, 11, 52, 41, 764, DateTimeKind.Local).AddTicks(8221),
                            FirstMidName = "Carlos",
                            LastName = "Che"
                        },
                        new
                        {
                            Id = 2,
                            EnrollmentDate = new DateTime(2023, 3, 31, 11, 52, 41, 764, DateTimeKind.Local).AddTicks(8233),
